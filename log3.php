...
<section class="content-header">
  ...
  <?php include('config.php');
              $sql = "SELECT * FROM log3 ORDER BY log_time
              DESC";
          ...
          <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info" border="1">
              <thead>
                <tr role="row" class="info">
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 3%;"><center>NO. </center></th>
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><center>start_value</center></th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><center>end_value</center></th>
              ...
              <tbody ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false">
                <?php
                    ...
                    ?>
                <tr>
                    <td><center><?php echo $Crow;?></center></td>
