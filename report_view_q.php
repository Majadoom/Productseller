...
if ($OrderDate == "q1") {
              ...
              $sql = "SELECT orders.OrderDate,
                      ...
                      WHERE MONTH(orders.OrderDate) = '10' AND YEAR(orders.OrderDate) = '$OrderYear' -1 AND orders.Office   = '{$_SESSION['Office']}' 
                                                                                                        AND orders.Partwork = '{$_SESSION['Partwork']}'
                                                                                                        AND orders.Work     = '{$_SESSION['Work']}'
                         || MONTH(orders.OrderDate) = '11' AND YEAR(orders.OrderDate) = '$OrderYear' -1 AND orders.Office   = '{$_SESSION['Office']}'
                                                                                                        AND orders.Partwork = '{$_SESSION['Partwork']}'
                                                                                                        AND orders.Work     = '{$_SESSION['Work']}'
                         || MONTH(orders.OrderDate) = '12' AND YEAR(orders.OrderDate) = '$OrderYear' -1 AND orders.Office   = '{$_SESSION['Office']}' 
                                                                                                        AND orders.Partwork = '{$_SESSION['Partwork']}'
                                                                                                        AND orders.Work     = '{$_SESSION['Work']}' ";
}
if ($OrderDate == "q2") {
              ...
              $sql = "SELECT orders.OrderDate,
                     ...
                     WHERE MONTH(orders.OrderDate) = '01' AND YEAR(orders.OrderDate) = '$OrderYear'  AND orders.Office   = '{$_SESSION['Office']}' 
                                                                                                     AND orders.Partwork = '{$_SESSION['Partwork']}'
                                                                                                     AND orders.Work     = '{$_SESSION['Work']}'
                         || MONTH(orders.OrderDate) = '02' AND YEAR(orders.OrderDate) = '$OrderYear' AND orders.Office   = '{$_SESSION['Office']}'
                                                                                                     AND orders.Partwork = '{$_SESSION['Partwork']}'
                                                                                                     AND orders.Work     = '{$_SESSION['Work']}'
                         || MONTH(orders.OrderDate) = '03' AND YEAR(orders.OrderDate) = '$OrderYear' AND orders.Office   = '{$_SESSION['Office']}'  
                                                                                                     AND orders.Partwork = '{$_SESSION['Partwork']}'
                                                                                                     AND orders.Work     = '{$_SESSION['Work']}' ";
}
if ($OrderDate == "q3") {
              ...
              $sql = "SELECT orders.OrderDate,
                      ...
                      WHERE MONTH(orders.OrderDate) = '04' AND YEAR(orders.OrderDate) = '$OrderYear' AND orders.Office   = '{$_SESSION['Office']}' 
                                                                                                     AND orders.Partwork = '{$_SESSION['Partwork']}'
                                                                                                     AND orders.Work     = '{$_SESSION['Work']}'
                         || MONTH(orders.OrderDate) = '05' AND YEAR(orders.OrderDate) = '$OrderYear' AND orders.Office   = '{$_SESSION['Office']}'
                                                                                                     AND orders.Partwork = '{$_SESSION['Partwork']}'
                                                                                                     AND orders.Work     = '{$_SESSION['Work']}'
                         || MONTH(orders.OrderDate) = '06' AND YEAR(orders.OrderDate) = '$OrderYear' AND orders.Office   = '{$_SESSION['Office']}'  
                                                                                                     AND orders.Partwork = '{$_SESSION['Partwork']}'
                                                                                                     AND orders.Work     = '{$_SESSION['Work']}' ";
}
if ($OrderDate == "q4") {
              ...
              $sql = "SELECT orders.OrderDate,
                      ...
                      WHERE MONTH(orders.OrderDate) = '07' AND YEAR(orders.OrderDate) = '$OrderYear' AND orders.Office   = '{$_SESSION['Office']}' 
                                                                                                     AND orders.Partwork = '{$_SESSION['Partwork']}'
                                                                                                     AND orders.Work     = '{$_SESSION['Work']}'
                         || MONTH(orders.OrderDate) = '08' AND YEAR(orders.OrderDate) = '$OrderYear' AND orders.Office   = '{$_SESSION['Office']}'
                                                                                                     AND orders.Partwork = '{$_SESSION['Partwork']}'
                                                                                                     AND orders.Work     = '{$_SESSION['Work']}'
                         || MONTH(orders.OrderDate) = '09' AND YEAR(orders.OrderDate) = '$OrderYear' AND orders.Office   = '{$_SESSION['Office']}'  
                                                                                                     AND orders.Partwork = '{$_SESSION['Partwork']}'
                                                                                                     AND orders.Work     = '{$_SESSION['Work']}' ";
  }
}
if ($_SESSION['Userlevel']=='1') {
  if ($OrderDate == "q1") {
              ...
              $sql = "SELECT orders.OrderDate,
                      ...
                      WHERE MONTH(orders.OrderDate) = '10' AND YEAR(orders.OrderDate) = '$OrderYear' -1 
                         || MONTH(orders.OrderDate) = '11' AND YEAR(orders.OrderDate) = '$OrderYear' -1 
                         || MONTH(orders.OrderDate) = '12' AND YEAR(orders.OrderDate) = '$OrderYear' -1  ";
}
if ($OrderDate == "q2") {
              ...
              $sql = "SELECT orders.OrderDate,
                     ...
                     WHERE MONTH(orders.OrderDate) = '01' AND YEAR(orders.OrderDate) = '$OrderYear'  
                        || MONTH(orders.OrderDate) = '02' AND YEAR(orders.OrderDate) = '$OrderYear' 
                        || MONTH(orders.OrderDate) = '03' AND YEAR(orders.OrderDate) = '$OrderYear' ";
}
if ($OrderDate == "q3") {
              ...
              $sql = "SELECT orders.OrderDate,
                      ...
                      WHERE MONTH(orders.OrderDate) = '04' AND YEAR(orders.OrderDate) = '$OrderYear' 
                         || MONTH(orders.OrderDate) = '05' AND YEAR(orders.OrderDate) = '$OrderYear' 
                         || MONTH(orders.OrderDate) = '06' AND YEAR(orders.OrderDate) = '$OrderYear' ";
}
if ($OrderDate == "q4") {
              ...
              $sql = "SELECT orders.OrderDate,
                      ...
                      WHERE MONTH(orders.OrderDate) = '07' AND YEAR(orders.OrderDate) = '$OrderYear' 
                         || MONTH(orders.OrderDate) = '08' AND YEAR(orders.OrderDate) = '$OrderYear' 
                         || MONTH(orders.OrderDate) = '09' AND YEAR(orders.OrderDate) = '$OrderYear' ";
  }
}
...
<div class="card-body p-1">
        <div class="row">
          ...
          <table id="example1" class="table table-bordered table-striped dataTable" 
                      role="grid" aria-describedby="example1_info" width="900" border="1">
              <thead>
