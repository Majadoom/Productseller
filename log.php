          ...
          <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info" border="1">
              <thead>
                <tr role="row" class="info">
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 7%;"><center>key_id</center></th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 7%;"><center>action_name</center></th>
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 10%;"><center>new_value</center></th>
