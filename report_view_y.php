...
$DateThai = date("Y-m-d",strtotime("-543year".$OrderDate));
...
if ($_SESSION['Userlevel']== '2' || '3' || '5' || '6') {
              ...
              $sql = "SELECT orders.OrderDate,
                      ...
                      WHERE YEAR(orders.OrderDate)  = '{$DateThai}' AND orders.Office   = '{$_SESSION['Office']}'
...
if ($_SESSION['Userlevel']== '1') {
              ...
              $sql = "SELECT orders.OrderDate,
                      ...
                      WHERE YEAR(orders.OrderDate)  = '{$DateThai}' AND orders.Office  ";
}
          ...
          <table id="example1" class="table table-bordered table-striped dataTable" 
              ...
              <thead>
                <tr role="row" class="info">
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 1%;">วันที่สั่งซื้อ</th>
      ...
      while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
            ...
            <div align="right">
            <b>Sum Total = </b>
            <input type="text" value="<?php echo number_format($SumTotal,2);?>" style="width: 90px;" disabled="disabled" readonly="readonly">
