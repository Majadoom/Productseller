...
<section class="content-header">
  ...
  <?php include('config.php');
              $sql = "SELECT * FROM log_del1 ORDER BY id
          ...
          <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info" border="1">
              <thead>
                <tr role="row" class="info">
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><center>old_name</center></th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><center>old_buss</center></th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><center>old_mail</center></th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><center>old_tel</center></th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><center>old_add</center></th>
              ...
              <tbody ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false">
                <?php
                    ...
                    $old_buss     = $row['old_buss'];
                    $old_mail     = $row['old_mail'];
                    $old_tel      = $row['old_tel'];
                    $old_add      = $row['old_add'];
                ...
                <tr>
                    ...
                    <td><center><?php echo $old_name;?></center></td>
                    <td><center><?php echo $old_buss;?></center></td>
                    <td><center><?php echo $old_mail;?></center></td>
                    <td><center><?php echo $old_tel;?></center></td>
                    <td><center><?php echo $old_add;?></center></td>
