...
<section class="content-header">
  ...
  <?php include('config.php');
              $sql = "SELECT * FROM log_del2 ORDER BY id
          ...
          <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info" border="1">
              <thead>
                <tr role="row" class="info">
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><center>old_orderdate</center></th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><center>old_ordercusid</center></th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><center>old_usersell</center></th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><center>old_usersave</center></th>
              ...
              <tbody ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false">
                <?php
                    ...
                    $old_orderdate   = $row['old_orderdate'];
                    $old_ordercusid  = $row['old_ordercusid'];
                    $old_usersell    = $row['old_usersell'];
                    $old_usersave    = $row['old_usersave'];
                ...
                <tr>
                    ...
                    <td><center><?php echo $old_orderdate;?></center></td>
                    <td><center><?php echo $old_ordercusid;?></center></td>
                    <td><center><?php echo $old_usersell;?></center></td>
                    <td><center><?php echo $old_usersave;?></center></td>
